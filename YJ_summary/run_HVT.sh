...
# hadd all data
hadd result_cuts/data_$1_$2.root result_cuts/data*_$1_$2.root

# Bkg MC
root -b -l -q Main_analyzer/recoXMassCSV.C++\($3\,\"/data1/delpanjNtuple/delpanj_v4_TTTo2L2Nu2B.root\"\,\"result_cuts/TH2_TTTo2L2Nu2B_$1_$2.root\"\)
