...
void stackCSVsignalHisto(){
  ...
  TFile *dy70  = TFile::Open("rootfile/DYJets70To100.root");
  TFile *dy100 = TFile::Open("rootfile/DYJets100.root");
  TFile *ttbar = TFile::Open("rootfile/TTbar.root");
  TFile *ww    = TFile::Open("rootfile/WW.root");
  TFile *wz    = TFile::Open("rootfile/WZ.root");
  TFile *zz    = TFile::Open("rootfile/ZZ.root");
  TFile *data  = TFile::Open("rootfile/data.root");
  TFile *SIG   = TFile::Open("rootfile/signal_M2000.root");
  ...
  */
  ...
  img1->FromPad(c1);
  img1->WriteImage("h_jetCSVshape2000.png");
  delete c1;
  delete img1;
