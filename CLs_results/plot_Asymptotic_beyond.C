...
void plot_Asymptotic_beyond(string outputname);
void setFPStyle();
...
//  gROOT->LoadMacro("CMS_lumi.C");
  ...
  TFile *fFREQ[nXm];
  TTree *t[nXm];
  int Xmass[nXm]={800,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000,2200,2400,2600,2800,3000};  
  ...
  string xsect_file_th = dirXSect + "xsec_Zhllbb_beyond.txt";
...
//   }
  ...
  double fr_left = 800.0, fr_down = 7E-6, fr_right = 3000.0, fr_up = 5;
