...
void combineAlpha(){
  ...
  img1->FromPad(c1);
  img1->WriteImage("h_combineAlpha.png");
  delete c1;
  delete img1;
...
void myPlot(TH1D* h_dy70, TH1D* h_dy100, TH1D* h_ttbar, TH1D* h_dy70m, TH1D* h_dy100m, TH1D* h_ttbarm){
  ...
  h_bkg->Add(h_dy70m,scale1);
  h_bkg->Add(h_dy100m,scale2);
  h_bkg->Add(h_ttbarm,scale3);
