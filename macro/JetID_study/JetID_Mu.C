//root -q -b -l JetID_mm.C++\(\"inputFile\"\,\"outputFile\"\)
...
using namespace std;
void JetID_mm(std::string inputFile, std::string outputFile){
  ...
  h_CA8jetMuEF->GetXaxis()->SetTitle("MuonEnergyFraction-muon channel");
  h_CA8jetPhoEF->GetXaxis()->SetTitle("PhotonEnergyFraction-muon channel");
  h_CA8jetCEmEF->GetXaxis()->SetTitle("ChargedEmEnergyFraction-muon channel");
  h_CA8jetCHadEF->GetXaxis()->SetTitle("ChargedHadronEnergyFraction-muon channel");
  h_CA8jetNEmEF->GetXaxis()->SetTitle("NeutralEmEnergyFraction-muon channel");
  h_CA8jetNHadEF->GetXaxis()->SetTitle("NeutralHadronEnergyFraction-muon channel");
  h_CA8jetCMulti->GetXaxis()->SetTitle("ChargedMultiplicity-muon channel");
